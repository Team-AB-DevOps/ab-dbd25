...
public class AuthService : IAuthService
{
    ...
    public AuthService(IUserRepository userRepository, IPasswordHasher passwordHasher, IJwtGenerator jwtGenerator, IPrivilegesRepository privilegesRepository)
    {
    ...
    public async Task<TokenUserResponseDto> Login(LoginRequestDto loginRequestDto)
    {
        ...
        return new TokenUserResponseDto(token, new UserResponseDto(userInDb.FirstName, userInDb.LastName, userInDb.Email, userInDb.Id));
    }
}