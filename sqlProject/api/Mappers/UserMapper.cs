...
public static class UserMapper
{
    ...
    public static UserDto FromNeo4jRecordToUserDto(this IRecord record)
    {
        ...
        var profiles = profilesDataList
            ...
            .Select((dict, profileIndex) =>
            {
                var profileNode = (INode)dict["profile"];
                
                // Extract reviews for this specific profile
                var profileReviewsList = dict.ContainsKey("reviews") && dict["reviews"] != null
                ...
                var reviews = profileReviewsList
                    ...
                    .Where(reviewDict => reviewDict.ContainsKey("media") && reviewDict["media"] != null)
                    .Select((reviewDict, index) =>
                    {
                        var mediaNode = (INode)reviewDict["media"];
                        
                        var rating = reviewDict.ContainsKey("rating") && reviewDict["rating"] != null
                            ? reviewDict["rating"].As<int>()
                            : 0;
                        var description = reviewDict.ContainsKey("description") && reviewDict["description"] != null
                ...
                var profileWatchlistsList = dict.ContainsKey("watchlists") && dict["watchlists"] != null
                ...
                var watchlistData = profileWatchlistsList
                    ...
                    .Where(wDict => wDict.ContainsKey("watchlist") && wDict["watchlist"] != null)
                    .Select(wDict => new
                    {
                        Watchlist = (INode)wDict["watchlist"],
                        Media = wDict.ContainsKey("media") && wDict["media"] != null ? (INode)wDict["media"] : null
                    })
                    .ToList();
                ...
                var isLocked = watchlistData.FirstOrDefault()?.Watchlist.Properties.ContainsKey("isLocked") == true
                ...
                return new ProfileDto(
                    profileNode.Properties.ContainsKey("name") ? profileNode.Properties["name"].As<string>() : string.Empty,
                    profileNode.Properties.ContainsKey("isChild") ? profileNode.Properties["isChild"].As<bool?>() : null,
                    watchlist,
                    reviews
                );
            })
        ...
        return new UserDto(
            ...
            userNode.Properties.ContainsKey("firstName") ? userNode.Properties["firstName"].As<string>() : string.Empty,
            userNode.Properties.ContainsKey("lastName") ? userNode.Properties["lastName"].As<string>() : string.Empty,
            subscriptions,
            privileges,
            profiles
        );
